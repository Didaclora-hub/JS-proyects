...
console.log(a % b) // Módulo --> Es el resto de la division
console.log(a ** b) // Exponente

a++ // Incremento --> sumamos +1 al valor de la variable 'a' en este caso
console.log(a)

b-- // Decremento --> restamos -1 al valor de la variable 'b' en este caso 
console.log(b)
...
myVariable += 2 // Suma con asignación (Acortamos) --> myvariable = myvariable + 2
console.log(myVariable)
